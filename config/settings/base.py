...
ROOT_DIR = environ.Path(__file__) - 3  # (loaf/config/settings/base.py - 3 = loaf/)
APPS_DIR = ROOT_DIR.path('loaf')
...
MIGRATION_MODULES = {
    'sites': 'loaf.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'loaf.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
SOCIALACCOUNT_QUERY_EMAMIL = True
