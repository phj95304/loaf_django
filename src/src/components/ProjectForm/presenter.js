...
export default class ProjectForm extends React.Component  {
    constructor() {
        ...
        this.state = {
          modalVisible: false,
          uploading: false,
          file : 'https://images.unsplash.com/photo-1516175429637-084c2acfc82d?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=fb291002afe37bbb5638f541eca1a2cc&auto=format&fit=crop&w=2064&q=80',
          title : '테스트',
          caption: 'ㅇㄹㅇㄹㅇㄹ',
          max_member: '4',
          schedule : '2018.10.20~2018.12.20',
          tags0: '테스트',
          tags1:'입니다',
          tags2:'아이시',
          apt0:'일까요',
    ...
    const tagsArray =  "[\"" + this.state.tags0+ "\",\""+ this.state.tags1+"\",\"" +this.state.tags2+"\"]";
   
    console.log("-----tagsArray-------");
    console.log(tagsArray)

    console.log("-----aptArray-------");
    const aptArray = this.state.apt0+","+this.state.apt1+","+this.state.apt2
    console.log(aptArray)
//server change this
////http:/192.168.0.3:8000/users/
...
formData.append('max_member', this.state.max_member);
formData.append('schedule',this.state.schedule);
formData.append('tags', tagsArray);
formData.append('apt', aptArray);


      console.log(formData)
      console.log("====== 위에 form data!")
      fetch(`http://222.111.115.100:8000/projects/`, {// change this
        method: 'POST', 
        credentials: 'include',
        headers:{
