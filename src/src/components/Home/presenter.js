...
export default class Home extends Component {
  ...
  render() {
      ...
      const profile_image = navigation.getParam('profile_image', 'NO IMAGE');
      const name = navigation.getParam('name', '이름..');
      const address = navigation.getParam('address', '지역...');
      const school =  navigation.getParam('school', '학교.....');
      const major = navigation.getParam('major', '전공...');
      const bio = navigation.getParam('bio', '소개...');
      const website = navigation.getParam('website', '사이트...');
      const tags = navigation.getParam('tags', '관심사');
            ...
            <View style= {{flex:1, justifyContent: 'center',
             ...
             <Image source={logout} style={{height:50, width:50}}/>
              ...
              <View style= {{flex:1, justifyContent: 'center',
                      alignItems: 'center' }}>
               <TouchableOpacity
                  onPress={() =>  navigation.navigate('ContestInfo')}>
